        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="text-center bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 border border-red-500/30">
              <TrendingUp className="w-6 h-6 sm:w-8 sm:h-8 text-red-400 mx-auto mb-2" strokeWidth={2.5} />
              <div className="text-3xl sm:text-4xl font-black text-red-400 mb-1 sm:mb-2">300%</div>
              <div className="text-xs sm:text-sm text-gray-300 font-bold">Avg Growth</div>
            </div>
            <div className="text-center bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 border border-red-500/30">
              <Award className="w-6 h-6 sm:w-8 sm:h-8 text-red-400 mx-auto mb-2" strokeWidth={2.5} />
              <div className="text-3xl sm:text-4xl font-black text-red-400 mb-1 sm:mb-2">500+</div>
              <div className="text-xs sm:text-sm text-gray-300 font-bold">Projects Done</div>
            </div>
            <div className="text-center bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 border border-red-500/30">
              <Target className="w-6 h-6 sm:w-8 sm:h-8 text-red-400 mx-auto mb-2" strokeWidth={2.5} />
              <div className="text-3xl sm:text-4xl font-black text-red-400 mb-1 sm:mb-2">98%</div>
            ...
            <div className="text-center bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 border border-red-500/30">
              ...
              <div className="text-3xl sm:text-4xl font-black text-red-400 mb-1 sm:mb-2">50M+</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {caseStudies.map((study, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-red-500/20 transition-all duration-500 group border-2 border-red-100/50 hover:-translate-y-2"
              >
                {/* Image */}
                <div className="relative h-56 sm:h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                    <p className="text-red-300 font-bold text-xs sm:text-sm mb-1">CLIENT</p>
                ...
                <div className="p-6 sm:p-8">
                  <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-3 line-clamp-2 group-hover:text-red-600 transition-colors">
                    {study.title}
                  </h3>
                  ...
                  <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-6">
                    {study.results.slice(0, 3).map((result, i) => (
                      <div key={i} className="text-center bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-3 border border-red-100/50">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center text-red-600 font-black group-hover:gap-3 gap-2 transition-all text-sm sm:text-base hover:text-red-700"
                  >
                    Read Case Study
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-red-500 via-red-600 to-orange-500 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-3 px-6 sm:px-8 py-4 bg-white text-red-600 rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 active:scale-100 font-black text-sm sm:text-base"
            >
              Start Your Project
