...
export default function ServicesPreview() {
  ...
  // VERY COMPETITIVE Kolkata Market Pricing (60% lower - AGGRESSIVE!)
  const getCompetitivePrice = (originalPrice: number) => {
    return Math.floor(originalPrice * 0.4); // 60% discount - Very Low!
  };
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-white relative overflow-hidden">
      ...
      {/* In the pricing section, update to show bigger savings badge */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Add savings badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-full text-sm font-black shadow-lg">
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <div className="px-3 py-1.5 bg-red-500 text-white text-xs font-black rounded-full shadow-lg animate-pulse">
                    60% OFF
                  </div>
                </div>
              ...
              <div className="p-6 lg:p-8 bg-white">
                ...
                <ul className="space-y-2 mb-6">
                  {service.features.slice(0, 4).map((feature, i) => (
                    <li
                      key={i}
                      className="flex items-start text-sm text-slate-600 font-semibold"
                    >
                      <span className="check-icon mr-2 mt-0.5 flex-shrink-0">
                        ✓
                      </span>
                ...
                <div className="flex items-center justify-between mb-6 pb-6 border-b border-slate-100">
                  ...
                  {service.pricing && (
                    <div className="pricing-display text-right">
                      <span className="price-label text-xs text-red-500 font-black block">
                        SPECIAL OFFER
                      </span>
                      <div className="flex items-baseline gap-2">
                        <span className="price-amount text-2xl font-black text-red-600">
                          ₹
                          {(
                            getCompetitivePrice(service.pricing.starter) / 1000
                          ).toFixed(1)}
                          K
                        </span>
                ...
                <div className="card-actions-new flex gap-3">
                  <Link
                    ...
                    className="flex-1 px-4 py-3.5 bg-slate-900 text-white rounded-xl hover:bg-teal-600 transition-all font-bold text-sm text-center flex items-center justify-center gap-2 shadow-lg active:scale-95"
                  ...
                  <a
                    ...
                    className="flex-1 px-4 py-3.5 bg-[#25D366] text-white rounded-xl hover:bg-[#20BA5A] transition-all font-bold text-sm text-center flex items-center justify-center gap-2 shadow-lg active:scale-95"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <svg
                      width="18"
